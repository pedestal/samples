  ...
  {:helloworld-app2
   {;; :build contains parameters which are passed to the build
    ...
    :aspects {;; Add an aspect that uses the data renderer
              ...
              :development {:uri "/helloworld-app2-dev.html"
                            :name "Development"
                            :out-file "helloworld-app2-dev.js"
                            :main 'helloworld_app2.start
                            :logging? true
                            :order 3}
              :fresh {:uri "/fresh.html"
                      ...
                      :output-root :tools-public
                      :template "tooling.html"}
              :production {:uri "/helloworld-app2.html"
                           :name "Production"
                           :optimizations :advanced
                           :out-file "helloworld-app2.js"
                           :main 'helloworld_app2.start
                           :order 5}}}})
